 ...
 */
include_once (dirname(__FILE__).'/mail/Binariesmultimailer.php');

/**
 * Class for sending mail.
 *
 * Changed to use the facilities of  {@link BinariesMultiMailer}
 *
 * @package class
 * @subpackage mail
 * @author Kazumi Ono <onokazu@xoops.org>
 */
class BinariesMailer
{
    /**
     * reference to a {@link BinariesMultiMailer}
     *
     * @var BinariesMultiMailer
     * @access private
     ...
     * Constructor
     *
     * @return BinariesMailer
     */
    function BinariesMailer($from, $fromname, $method = 'mail')
    {
        $this->multimailer = new BinariesMultiMailer($from, $fromname, $method);
        $this->reset();
        $this->from = $from;
     ...
     * Send email
     *
     * Uses the new BinariesMultiMailer
     *
     * @param string $
     * @param string $
     * @param string $
