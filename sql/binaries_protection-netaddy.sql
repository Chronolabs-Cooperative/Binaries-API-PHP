...
--
-- Table structure for table `protection-netaddy`
--

DROP TABLE IF EXISTS `protection-netaddy`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `protection-netaddy` (
  `netaddy-id` int(22) NOT NULL,
...
--
-- Dumping data for table `protection-netaddy`
--

LOCK TABLES `protection-netaddy` WRITE;
/*!40000 ALTER TABLE `protection-netaddy` DISABLE KEYS */;
/*!40000 ALTER TABLE `protection-netaddy` ENABLE KEYS */;
UNLOCK TABLES;
