...
--
-- Table structure for table `statistics-cities-monthly`
--

DROP TABLE IF EXISTS `statistics-cities-monthly`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `statistics-cities-monthly` (
  `cities-monthly-id` mediumint(42) NOT NULL AUTO_INCREMENT,
  ...
  PRIMARY KEY (`cities-monthly-id`),
  KEY `STATISTICS` (`state-id`,`city-id`,`year`,`month`,`quarter`,`last-ip`,`hits`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `statistics-cities-monthly`
--

LOCK TABLES `statistics-cities-monthly` WRITE;
/*!40000 ALTER TABLE `statistics-cities-monthly` DISABLE KEYS */;
/*!40000 ALTER TABLE `statistics-cities-monthly` ENABLE KEYS */;
UNLOCK TABLES;
