...
--
-- Table structure for table `statistics-regions-hourly`
--

DROP TABLE IF EXISTS `statistics-regions-hourly`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `statistics-regions-hourly` (
  `regions-hourly-id` mediumint(42) NOT NULL AUTO_INCREMENT,
  ...
  PRIMARY KEY (`regions-hourly-id`),
  KEY `STATISTICS` (`state-id`,`region-id`,`year`,`month`,`day`,`week`,`hour`,`name`,`last-ip`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `statistics-regions-hourly`
--

LOCK TABLES `statistics-regions-hourly` WRITE;
/*!40000 ALTER TABLE `statistics-regions-hourly` DISABLE KEYS */;
/*!40000 ALTER TABLE `statistics-regions-hourly` ENABLE KEYS */;
UNLOCK TABLES;
