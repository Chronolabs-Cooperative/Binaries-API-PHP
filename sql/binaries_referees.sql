...
CREATE TABLE `referees` (
  `referee-id` mediumint(44) NOT NULL AUTO_INCREMENT,
  `key` varchar(32) DEFAULT '',
  `site-id` mediumint(29) DEFAULT '0',
  `user-id` int(18) DEFAULT '0',
  `request-uri` varchar(300) DEFAULT '',
  `access` enum('granted','denied','returned','unknown') DEFAULT 'granted',
  `last` int(12) DEFAULT '0',
  `hits` int(10) DEFAULT '0',
  `last-ip` mediumint(33) DEFAULT '0',
  `server-ip` mediumint(33) DEFAULT '0',
  `callback` enum('yes','no') DEFAULT 'no',
  `callback-referees-id` mediumint(29) DEFAULT '0',
  PRIMARY KEY (`referee-id`)
