...
--
-- Table structure for table `statistics-cities-weekly`
--

DROP TABLE IF EXISTS `statistics-cities-weekly`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `statistics-cities-weekly` (
  `cities-weekly-id` mediumint(42) NOT NULL AUTO_INCREMENT,
  ...
  PRIMARY KEY (`cities-weekly-id`),
  KEY `STATISTICS` (`state-id`,`city-id`,`year`,`month`,`week`,`quarter`,`last-ip`,`hits`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `statistics-cities-weekly`
--

LOCK TABLES `statistics-cities-weekly` WRITE;
/*!40000 ALTER TABLE `statistics-cities-weekly` DISABLE KEYS */;
/*!40000 ALTER TABLE `statistics-cities-weekly` ENABLE KEYS */;
UNLOCK TABLES;
