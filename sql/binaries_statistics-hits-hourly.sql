...
--
-- Table structure for table `statistics-hits-hourly`
--

DROP TABLE IF EXISTS `statistics-hits-hourly`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `statistics-hits-hourly` (
  `hourly-id` mediumint(42) NOT NULL AUTO_INCREMENT,
  `state-id` int(29) DEFAULT '0',
  `user-id` int(18) DEFAULT '0',
  `referee-id` mediumint(42) DEFAULT NULL,
  ...
  PRIMARY KEY (`hourly-id`),
  KEY `STATISTICS` (`state-id`,`year`,`month`,`day`,`week`,`hour`,`name`,`last-ip`,`hits`,`user-id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `statistics-hits-hourly`
--

LOCK TABLES `statistics-hits-hourly` WRITE;
/*!40000 ALTER TABLE `statistics-hits-hourly` DISABLE KEYS */;
/*!40000 ALTER TABLE `statistics-hits-hourly` ENABLE KEYS */;
UNLOCK TABLES;
