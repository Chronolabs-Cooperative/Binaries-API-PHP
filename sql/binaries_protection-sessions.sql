...
--
-- Table structure for table `protection-sessions`
--

DROP TABLE IF EXISTS `protection-sessions`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `protection-sessions` (
  `session-id` int(22) NOT NULL AUTO_INCREMENT,
  ...
  KEY `INDEXING` (`key`(22),`bin-id`,`hits`,`maximum`,`expires`),
  KEY `BACKEND` (`key`(22),`bin-id`,`notify`,`callback-referee`,`callback-notify-when`,`callback-polled-when`,`callback-maximum-when`,`callback-expired-when`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `protection-sessions`
--

LOCK TABLES `protection-sessions` WRITE;
/*!40000 ALTER TABLE `protection-sessions` DISABLE KEYS */;
/*!40000 ALTER TABLE `protection-sessions` ENABLE KEYS */;
UNLOCK TABLES;
