...
--
-- Table structure for table `statistics-hits-monthly`
--

DROP TABLE IF EXISTS `statistics-hits-monthly`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `statistics-hits-monthly` (
  `monthly-id` mediumint(42) NOT NULL AUTO_INCREMENT,
  ...
  PRIMARY KEY (`monthly-id`),
  KEY `STATISTICS` (`state-id`,`year`,`month`,`quarter`,`last-ip`,`hits`,`user-id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `statistics-hits-monthly`
--

LOCK TABLES `statistics-hits-monthly` WRITE;
/*!40000 ALTER TABLE `statistics-hits-monthly` DISABLE KEYS */;
/*!40000 ALTER TABLE `statistics-hits-monthly` ENABLE KEYS */;
UNLOCK TABLES;
