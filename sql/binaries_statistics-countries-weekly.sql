...
--
-- Table structure for table `statistics-countries-weekly`
--

DROP TABLE IF EXISTS `statistics-countries-weekly`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `statistics-countries-weekly` (
  `countries-weekly-id` mediumint(42) NOT NULL AUTO_INCREMENT,
  ...
  PRIMARY KEY (`countries-weekly-id`),
  KEY `STATISTICS` (`state-id`,`country-id`,`year`,`month`,`week`,`quarter`,`last-ip`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `statistics-countries-weekly`
--

LOCK TABLES `statistics-countries-weekly` WRITE;
/*!40000 ALTER TABLE `statistics-countries-weekly` DISABLE KEYS */;
/*!40000 ALTER TABLE `statistics-countries-weekly` ENABLE KEYS */;
UNLOCK TABLES;
