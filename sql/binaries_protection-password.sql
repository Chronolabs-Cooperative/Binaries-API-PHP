...
--
-- Table structure for table `protection-password`
--

DROP TABLE IF EXISTS `protection-password`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `protection-password` (
  `password-id` int(22) NOT NULL AUTO_INCREMENT,
  `client-id` mediumint(22) DEFAULT '0',
  ...
  KEY `INDEXING` (`client-id`,`bin-id`,`hits`,`maximum`,`expires`),
  KEY `BACKEND` (`client-id`,`bin-id`,`notify`,`callback-referee`,`callback-notify-when`,`callback-polled-when`,`callback-maximum-when`,`callback-expired-when`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `protection-password`
--

LOCK TABLES `protection-password` WRITE;
/*!40000 ALTER TABLE `protection-password` DISABLE KEYS */;
/*!40000 ALTER TABLE `protection-password` ENABLE KEYS */;
UNLOCK TABLES;
