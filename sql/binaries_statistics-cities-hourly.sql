...
--
-- Table structure for table `statistics-cities-hourly`
--

DROP TABLE IF EXISTS `statistics-cities-hourly`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `statistics-cities-hourly` (
  `cities-hourly-id` mediumint(42) NOT NULL AUTO_INCREMENT,
  ...
  PRIMARY KEY (`cities-hourly-id`),
  KEY `STATISTICS` (`state-id`,`city-id`,`year`,`month`,`day`,`week`,`hour`,`name`,`last-ip`,`hits`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `statistics-cities-hourly`
--

LOCK TABLES `statistics-cities-hourly` WRITE;
/*!40000 ALTER TABLE `statistics-cities-hourly` DISABLE KEYS */;
/*!40000 ALTER TABLE `statistics-cities-hourly` ENABLE KEYS */;
UNLOCK TABLES;
